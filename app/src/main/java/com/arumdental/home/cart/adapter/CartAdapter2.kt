...
import kotlinx.android.synthetic.main.item_checkout.view.ivMinusUpdate
import kotlinx.android.synthetic.main.item_checkout.view.ivPlusUpdate
import kotlinx.android.synthetic.main.item_checkout.view.tvProductName
import kotlinx.android.synthetic.main.item_checkout.view.tvProductPrice
import kotlinx.android.synthetic.main.item_checkout.view.tvProductQuantity
import kotlinx.android.synthetic.main.item_checkout2.view.*

class CartAdapter2 (var context: Context, var list:ArrayList<CartResponse>): RecyclerView.Adapter<CartAdapter2.Viewholder>() {
    ...
    override fun onBindViewHolder(holder: Viewholder, position: Int) {
        ...
        holder.itemView.tvProductQuant.setText("Qunatity :" + list.get(position).quantity)
